                ...
                <div className="column is-half">
                    <div className="columns is-desktop is-centered">
                        ...
                        <div className="column">
                            ...
                            <p className="subtitle is-4">Namastay <span role="img" aria-label="zangy face">🤪</span>, I am a <a href="https://unsplash.com/@ranjanarajput">junior photographer</a> who likes to click nature (mostly environment and animals) and busy completing my graduation these days. I do and learning content writing, website development, digital marketing content generation, and many more. Also, am planning to start something of my own sooner or later. </p>
                        </div>
                    </div>
                </div>
            </div>
